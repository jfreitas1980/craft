...
var btns=new Array();
btns[0]=new Image(); btns[0].src="images/botoes/min.gif";
btns[1]=new Image(); btns[1].src="images/botoes/max.gif";
btns[2]=new Image(); btns[2].src="images/botoes/close.gif";
btns[3]=new Image(); btns[3].src="images/botoes/resize.gif";
}
preloadBttns();
...
if(isresize){
rdiv.innerHTML='<img src="images/botoes/resize.gif" width="7" height="7">';
...
var tmp=(isresize)?'<img src="images/botoes/min.gif" width="16" height="16" id="'+cid+'_min"><img src="images/botoes/max.gif" width="16" height="16"  id="'+cid+'_max">':'';
titlebar.innerHTML='<span style="position:absolute; left:3px; top:1px; font:bold 10pt sans-serif; color:'+titletextcolor+'; height:18px; overflow:hidden; clip-height:16px;">'+title+'</span><div id="'+cid+'_btt" style="position:absolute; width:48px; height:16px; left:'+(tw-48)+'px; top:2px; text-align:right">'+tmp+'<img src="images/botoes/close.gif" width="16" height="16" id="'+cid+'_cls"></div>';
tw=(ie5)?w-7:w-13;
