                ...
                $('document').ready( function () {
                    ...
                    $('#ccim204__csag308_nr').removeClass('ddEntryCombo');
                    $('#ccim204__operacao').removeClass('ddEntryCombo');
                    $('#ccim204__modalidade').removeClass('ddEntryCombo');
                
                    $('#btn-SAVE').click(function(){
                        var aEmpresa = $('#ccim204__csag308_nr').val();
                        if (aEmpresa == 0 || aEmpresa == '') {
                          jAlert('warning', 'Selecione uma Empresa', 'Atencao', function(r){
                              if (r) {
                                $('#ccim204__csag308_nr').select();
                                $('#ccim204__csag308_nr').focus();
                                return false;
                              }
                          });
                        } else { jsOK=0 };
