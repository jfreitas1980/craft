                ...
                $('document').ready( function () {
                    ...
                    $('#csag370__csag308_nr').removeClass('ddEntryCombo');
                    $('#csag370__campo_tipo').removeClass('ddEntryCombo');
                
                    $('#btn-SAVE').click(function(){
                        var aEmpresa = $('#csag370__csag308_nr').val();
                        if (aEmpresa == 0 || aEmpresa == '') {
                          jAlert('warning', 'Selecione uma Empresa', 'Atencao', function(r){
                              if (r) {
                                $('#csag370__csag308_nr').select();
                                $('#csag370__csag308_nr').focus();
                                return false;
                              }
                          });
                        } else { jsOK=0 };
