                ...
                $('document').ready( function () {
                    ...
                    //removeClass
                    $('#csag379__csag308_nr').removeClass('ddEntryCombo');
                    $('#csag379__csag378_cd').removeClass('ddEntryCombo');
                    $('#csag379__divisao_id').removeClass('ddEntryCombo');
   
                
                    $('#btn-SAVE').click(function(){
                        var aEmpresa = $('#csag379__csag308_nr').val();
                        if (aEmpresa == 0 || aEmpresa == '') {
                          jAlert('warning', 'Selecione uma Empresa', 'Atencao', function(r){
                              if (r) {
                                $('#csag379__csag308_nr').select();
                                $('#csag379__csag308_nr').focus();
                                return false;
                              }
                          });
                        } else { jsOK=0 };
