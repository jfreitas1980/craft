                ...
                $('document').ready( function () {
					// DESABILITAR O CAMPO
                    $('#ccgs233__codigo').attr('disabled', 'disabled'); 
                    $('#ccgs233__csag320_id').attr('disabled', 'disabled'); 
                    $('#ccgs233__pessoa_nrdocto').attr('disabled', 'disabled'); 
                    $('#ccgs233__situacao_dthr').attr('disabled', 'disabled'); 
