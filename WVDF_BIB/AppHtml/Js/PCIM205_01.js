                ...
                $('document').ready( function () {
                    ...
                    $('#ccim205__csag308_nr').removeClass('ddEntryCombo');
                    $('#ccim205__operacao').removeClass('ddEntryCombo');
                    $('#ccim205__modalidade').removeClass('ddEntryCombo');
                
                    $('#btn-SAVE').click(function(){
                        var aEmpresa = $('#ccim205__csag308_nr').val();
                        if (aEmpresa == 0 || aEmpresa == '') {
                          jAlert('warning', 'Selecione uma Empresa', 'Atencao', function(r){
                              if (r) {
                                $('#ccim205__csag308_nr').select();
                                $('#ccim205__csag308_nr').focus();
                                return false;
                              }
                          });
                        } else { jsOK=0 };
