        ...
        if (this.store && Ext.isFunction(this.store.on)) {
            ...
            var setLink = function () {
                ...
                Downloadify.create(this.btnEl, {
                    ...
                    onError: function () {
                        alert('Houve um erro ao tentar salvar o relatórios, tente novamente.');
                    },
                    filename: 'export.xls',
                    data: Ext.ux.Exporter[config.exportFunction](this.component, null, config),
                    swf: '../../WVDF_CAC_8/Js/ext/downloadify/media/downloadify.swf',
                    downloadImage: '../../WVDF_CAC_8/Js/ext/downloadify/images/download.png',
                    dataType: 'base64',
                    width: 100,
                    height: 30,
