...
function variaveis() {
    ...
    vCsag320RecId = $('#aCSAG320RecId').val();
}
$(document).ready(function() {
    variaveis();
    if (vCsag320RowId === "") {
        $("#ifrm-pag320_01").attr({
            "src": "pag320_02_new.asp?aUsuarioSessao=" + vUsuarioSessao + "&RowId=" + vCsag320RowId
        });
    } else {
        $("#ifrm-pag320_01").attr({
    ...
    $(document).on('click', '#li-pagTeste', function() {
        ...
        $("#ifrm-pagTeste").attr({
            "src": "crm_fotografia_cliente.html?idCliente=" + vCsag320Codigo +'&aUsuarioSessao=' + vUsuarioSessao
        })
    });

    $(document).on('click', '#li-pag320_01', function() {
        variaveis();

        if (vCsag320RowId === "") {
            $("#ifrm-pag320_01").attr({
                "src": "pag320_02.asp?aUsuarioSessao=" + vUsuarioSessao + "&RowId=" + vCsag320RowId
            });
        } else {
            $("#ifrm-pag320_01").attr({
                "src": "pag320_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&RowId=" + vCsag320RowId
    ...
    $(document).on('click', '#li-pag366_01', function() {
        variaveis();
        $("#ifrm-pag366_01").attr({
            "src": "pag366_03.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag352_01', function() {
        variaveis();
        $("#ifrm-pag352_01").attr({
            "src": "pag352_02.asp?RunReport=1&aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag374_01', function() {
        variaveis();
        $("#ifrm-pag374_01").attr({
            "src": "pag374_03.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag350_01', function() {
        variaveis();
        $("#ifrm-pag350_01").attr({
            "src": "pag350_02.asp?RunReport=1&aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag340_01', function() {
        variaveis();
        $("#ifrm-pag340_01").attr({
    ...
    $(document).on('click', '#li-pag378_01', function() {
        variaveis();
        $("#ifrm-pag378_01").attr({
            "src": "pag378_02.asp?RunReport=1&aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag341_01', function() {
        variaveis();
        $("#ifrm-pag341_01").attr({
            "src": "pag341_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag395_01', function() {
        variaveis();
        $("#ifrm-pag395_01").attr({
            "src": "pag395_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag342_01', function() {
        variaveis();
        $("#ifrm-pag342_01").attr({
            "src": "pag342_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag343_01', function() {
        variaveis();
        $("#ifrm-pag343_01").attr({
            "src": "pag343_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag345_01', function() {
        variaveis();
        $("#ifrm-pag345_01").attr({
            "src": "pag345_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag346_01', function() {
        variaveis();
        $("#ifrm-pag346_01").attr({
            "src": "pag346_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag347_01', function() {
        variaveis();
        $("#ifrm-pag347_01").attr({
            "src": "pag347_01.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
    $(document).on('click', '#li-pag349_01', function() {
        variaveis();
        $("#ifrm-pag349_01").attr({
    ...
    $(document).on('click', '#li-pag335_01', function() {
        variaveis();
        $("#ifrm-pag335_01").attr({
            "src": "pag335_03.asp?aUsuarioSessao=" + vUsuarioSessao + "&aCSAG320Id=" + vCsag320Codigo
        });
    });
});
