...
$scope.busca = function()
{
   ...
   crmLibrary.getRequest('crm/AcordosFinanceiros/Filial/'+$scope.idAcordo+'/'+$scope.sessaoUsuario).then(function(response){
...
if ($scope.validaInserir() == false) 
{
 ...
 console.log('novo',$scope.novo);
  ...
  console.log($scope.novo.filial);

console.log('data insert', data);
   crmLibrary.postRequest('crm/AcordosFinanceiros/Filial/'+$scope.sessaoUsuario, data).then(function(response){
      	console.log(response);
        $scope.busca();
        $scope.populaTabela();
         $scope.loadScreen = false;
...
console.log('edit',$scope.edit);
  var data = {
  "id_acordo_fin": item.id_acordo_fin, 
  ...
  console.log('alterar - data', data);
   ...
   crmLibrary.putRequest('crm/AcordosFinanceiros/Filial/'+$scope.sessaoUsuario, data).then(function(response){
        console.log(response);
        $scope.busca();
        $scope.populaTabela();
...
{
        $scope.loadScreen = true;
        var url = $scope.urlAPI + 'crm/AcordosFinanceiros/Filial/BuscaPorNome/'+$scope.idAcordo+'/'+value;
        console.log(url);
      return   $http({
        method : "GET",
        url : url
...
$scope.remover = function()
{
    	  ...
    	  $scope.loadScreen = true;
   crmLibrary.deleteRequest('crm/AcordosFinanceiros/Filial/'+$scope.selected.id_filial_acordo_financeiro+'/'+$scope.sessaoUsuario).then(function(response){
      	console.log(response);
        $scope.busca();
        $scope.populaTabela();
