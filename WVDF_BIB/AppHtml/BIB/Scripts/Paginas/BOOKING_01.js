...
// ANGULAR JS
app = angular.module('booking01App', ['ngTagsInput', 'wsDominio', 'toaster', 'diretivas', 'ngMaterial', 'ui.bootstrap', 'ui.utils.masks', 'ngTable']);
...
app.controller('chatCtrl2', function($scope, buscaWS, callWS, $http) {
    $scope.messages = [];
...
app.controller('booking01Controller', function($scope, $controller, buscaWS, callWS, $http, $q, toaster, $filter, NgTableParams) {
    $controller('comboCtrl', { $scope: $scope }); // controller de combobox
    $controller('chatCtrl2', { $scope: $scope }); // controller de Mensagens
...
$scope.btnSaveBooking1 = function() {

    $scope.CodPreBooking = true;
    $scope.bookingcodRef = 0009866898767;
}
