...
app.controller('produtosController', function($scope, $q, buscaWS, callWS, $http, $q, $filter, toaster, $timeout) {
    ...
    $scope.clickEditarProposta = function(oProposta) {
        ...
        var url = "PCGS3004_01.asp?aUsuarioSessao=" + getVariavelURL('aUsuarioSessao') + "&idVendedor=" + getVariavelURL('idVendedor') + "&idCliente=" + oProposta.CSAG320_ID + "&idProposta=" + oProposta.sPROPOSTA + "&Booking=";
        window.top.jaddTab("Proposta #" + oProposta.sPROPOSTA, url);
    }
    ...
    $scope.OpenBooking = function(oProposta) {
        ...
        buscaWS.get('/WVDF_WS/ws_HCGS3008.wso/fCriaBooking/JSON', 'aProp='+oProposta.sPROPOSTA).then(function(data) {
            var url = "PCGS3004_01.asp?aUsuarioSessao=" + getVariavelURL('aUsuarioSessao') + "&idVendedor=" + getVariavelURL('idVendedor') + "&idCliente=" + oProposta.CSAG320_ID + "&idProposta=" + oProposta.sPROPOSTA + "&Booking=" + data;
            // debugger;
            window.top.jaddTab("Proposta #" + oProposta.sPROPOSTA, url);
        });
