...
$('document').ready(function() {
    ...
    $("#csag345__csag320_id").val(jCsag320Id);

    // ESCONDE BOTÃO NOVO E PESQUISAR.
    $('#btnNovo').hide();
    $('#btnPesquisar').hide();

    $('#csag345__observacao').blur(function() {
        TextAreaLimite(this, 1022);
    });
});

// AngularJS
var app = angular.module('pag34501App', ['ui.bootstrap', 'ngTagsInput', 'wsDominio', 'diretivas', 'toaster', 'angularSoap']);
