var app = angular.module('pag39705', ['ui.bootstrap', 'wsDominio', 'diretivas']);

app.controller('pag39705Ctrl', ['$scope', 'callWS', '$timeout', function($scope, callWS, $timeout) {
  ...
  $scope.salesChange = function(){
    ...
    $scope.acSales = function(query) {
        var params = {
            'aUsuarioSessao': aUsuarioSessao,
            'aInicio': query,
        }; 
        return callWS.get('/WVDF_WS/ws_csag395.wso/fautocompleInsideSales/JSON', params).then(function(response) {
    ...
    var getDualList = function(currentPage, aOption, aPessoa) {
        ...
        callWS.get('/WVDF_WS/ws_CSAG397.wso/f_PesquisaCSAG397/JSON', params).then(function(response) {
    ...
    var atualizaWS = function(value) {
      ...
      //  console.log(params);
        callWS.get('/WVDF_WS/ws_CSAG397.wso/f_AtualizaCSAG397/JSON', params).then(function(response) {});
    }
