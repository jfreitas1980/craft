...
$scope.abreConfigModal = function(selected)
{
  ...
  console.log(selected);
    $scope.urlConfig ='crm_acordo_financeiro_setup_configuracao.html?idSetup='+selected.id_setup_financeiro+'&aUsuarioSessao='+$scope.sessaoUsuario;
    window.top.jaddTab('Configuração padrão para '+ selected.no_forma_pagamento, $scope.urlConfig);
...
$scope.busca = function()
{
   ...
   crmLibrary.getRequest('CRM/AcordosFinanceiros/SetupFinanceiroHeader/'+$scope.sessaoUsuario).then(function(response){
...
console.log('data insert', data);
   crmLibrary.postRequest('crm/AcordosFinanceiros/SetupFinanceiroHeader/'+$scope.sessaoUsuario, data).then(function(response){
      	console.log(response);
        $scope.busca();
        $scope.populaTabela();
         $scope.loadScreen = false;
...
console.log('edit' ,$scope.edit);
 ...
 console.log('notafiscal',$scope.notafiscal);
  ...
  console.log('alterar - data', data);
   ...
   crmLibrary.putRequest('crm/AcordosFinanceiros/SetupFinanceiroHeader/'+$scope.sessaoUsuario, data).then(function(response){
        console.log(response);
        $scope.busca();
        $scope.populaTabela();
...
{ 
  ...
  forma_pagamento: {"id_forma_pagamento": item.id_forma_pagamento , "no_forma_pagamento": item.no_forma_pagamento },
