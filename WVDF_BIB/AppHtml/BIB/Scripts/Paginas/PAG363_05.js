var app = angular.module('pag36305', ['ui.bootstrap', 'wsDominio', 'diretivas']);

app.controller('pag36305Ctrl', ['$scope', 'callWS', '$timeout', function($scope, callWS, $timeout) {
    ...
    var getDualList = function(currentPage, aOption, aPessoa) {
        ...
        callWS.get('/WVDF_WS/ws_csag363.wso/f_PesquisaCSAG363/JSON', params).then(function(response) {
    ...
    var atualizaWS = function(value) {
        var params = {
            'aUsuarioSessao': aUsuarioSessao,
            'aCSAG300_ID': $scope.usuario.id,
            'aMSAG362_ID': value.ID,
            'bSel': value.SEL
        };
      //  console.log(params);
        callWS.get('/WVDF_WS/ws_csag363.wso/f_AtualizaCSAG363/JSON', params).then(function(response) {});
    }
