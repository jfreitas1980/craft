...
angular.module("CROSSApp").controller("PlanoEstufagemCtrl", function($scope, $window,$location, $http){
    $scope.oManifest = {};
    ...
    $scope.GetPlano = function(iConsolId){

      var url = _getUrlAPIs() + "cross/Consolidation/ViewRelPlanoEstufagem/" 
