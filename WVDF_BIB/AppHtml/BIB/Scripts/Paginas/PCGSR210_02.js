// ANGULAR JS
var app = angular.module('pcgsr21001App', ['ui.bootstrap', 'smart-table', 'ngSanitize']);
...
app.controller('pcgsr21001Controller', function($scope, buscaWS, $http) {
	$scope.parametros = {};
	...
	$scope.btnPesquisa = function() {
		...
		$http({
		    url: '/WVDF_WS/ws_HCGSR210.wso/f_HCGSR210_REL/JSON', 
		    method: 'GET',
	...
	$scope.abreTela = function(sRowid) {
		url = "PCGSR210_01.asp?aUsuarioSessao=" + getVariavelURL('aUsuarioSessao') + "&RowId=" + sRowid;
