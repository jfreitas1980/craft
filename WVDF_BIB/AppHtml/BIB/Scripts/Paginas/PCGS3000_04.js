// ANGULAR JS
app = angular.module('pcgs300004App', ['ngSanitize', 'Alertify', 'angularSoap', 'diretivas', 'wsDominio', 'smart-table', 'ui.bootstrap', 'datatables', 'datatables.buttons', 'datatables.colreorder', 'ngTagsInput', 'toaster']);
...
app.controller('pcgs300004Controller', function($scope, Alertify, buscaWS, callWS, $http, $q, $compile, toaster, $uibModal) {
    ...
    var init = function() {
        ...
        buscaWS.get('/WVDF_WS/ws_ccgs220.wso/f_combo_tpcalc/JSON', 'aModal=M').then(function(data) {
    ...
    $scope.fGerarProposta = function (rowId) {
        debugger;
        var cliente;
        var nac;
        ...
        var params = 'sRecnum3000=' + rowId + '&sCliente=' + cliente + '&sClienteFinal=' + nac;
        buscaWS.get('/WVDF_WS/ws_hcgs3004.wso/fGeneratePropFromTarifario/JSON', params).then(function(data) {
            console.log(data);
            parent.parent.alertify.success('Proposta Gerada!');
        });
    }
