var app = angular.module('pag33405', ['ui.bootstrap', 'wsDominio', 'diretivas']);

app.controller('pag33405Ctrl', ['$scope', 'callWS', '$timeout', function($scope, callWS, $timeout) {
    ...
    var getDualList = function(currentPage, aOption, aPessoa) {
        ...
        callWS.get('/WVDF_WS/ws_CSAG334.wso/f_PesquisaCSAG334/JSON', params).then(function(response) {
    ...
    var atualizaWS = function(value) {
      ...
      //  console.log(params);
        callWS.get('/WVDF_WS/ws_CSAG334.wso/f_AtualizaCSAG334/JSON', params).then(function(response) {});
    }
    ...
    $scope.acGrupo = function(query){
        var params = {
            'aUsuarioSessao': aUsuarioSessao,
            'aInicio': query,
        };
        return callWS.get('/WVDF_WS/ws_csag332.wso/fautocompleGrupos/JSON', params).then(function(response){
