...
$scope.documento = crmLibrary.getParameterByName('documento');
...
$scope.busca = function()
{
   ...
   crmLibrary.getRequest('crm/DW/LogComex/'+$scope.documento).then(function(response){
       ...
       $scope.loadScreen = false;
       parent.parent.alertify.error("Ocorreu um erro ao buscar LogComex.");
        console.log("Ocorreu um erro ao buscar LogComex.");
    });
}
