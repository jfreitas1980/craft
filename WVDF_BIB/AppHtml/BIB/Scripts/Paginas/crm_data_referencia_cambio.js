var app = angular.module('dataReferenciaCambioApp', ['ngTable', 'ngRoute', 'ui.bootstrap', 'crmLibrary']);



app.controller('dataReferenciaCambioController', function ($scope, $http, NgTableParams, $location,$sce,crmLibrary) {
