...
$('document').ready( function () {
	...
	$("#csag343__csag320_id").val(jCsag320Id);

	// ESCONDE BOTÃO NOVO E PESQUISAR.
	$('#btnNovo').hide();
	$('#btnPesquisar').hide();

	$('#csag343__observacao').blur(function(){
...
app.controller('acordosController', function($scope, buscaWS, $sce, $http, soapService, toaster, callWS) {
    ...
    var getTrades = function() {
        ...
        callWS.get('/WVDF_WS/WS_csag379.wso/f_continente_list/JSON', params)
            .then(function(response) {
