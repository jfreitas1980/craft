...
app.controller('pag31605Ctrl', ['$scope', 'callWS', '$timeout', function($scope, callWS, $timeout) {
    ...
    var getDualList = function(currentPage, aOption, aPessoa) {
        ...
        callWS.get('/WVDF_WS/ws_csag314.wso/f_PesquisaCSAG314/JSON', params).then(function(response) {
    ...
    var atualizaWS = function(value) {
      ...
      //  console.log(params);
        callWS.get('/WVDF_WS/ws_csag314.wso/f_AtualizaCSAG314/JSON', params).then(function(response) {});
    }
