...
*/
    ...
    $scope.setClassInativo = function(oEmbalagem)
    {
        if(oEmbalagem.dt_Exclusao == null) 
        {
            return false;
        }
        else
    ...
    $scope.setarCheckInativo = function(_oEmbalagem){
        console.log("passou");
        if(_oEmbalagem.dt_Exclusao == null) 
        {
            _oEmbalagem.tp_Inativo = false;
            console.log("1");
        }
        else
        {
            _oEmbalagem.tp_Inativo = true;
            console.log("2");
        }
    };
