...
angular.module('2WA').factory('WVDF', ['$http', function($http) {
    function $$callGetJson(path, params) {
        return $http.get(path, { params: params }).then(function(response){ return response.data});
    }
    var WVDF_ws = {
        ws_hcgs3008: {
        ...
        ws_hcgs3004: {
            ...
            fPropostaFristLoad:  function(aPROPOSTA_ID, aUsuarioSessao) {
                var params = {
                    'sProposta': aPROPOSTA_ID,
                    'aUsuarioSessao': aUsuarioSessao
                }
                return $$callGetJson('/WVDF_WS/ws_hcgs3004.wso/fPropostaFristLoad/JSON', params);
            },
            ...
            p_att_status: function(aProp, aStatus, aPrograma, aUsuarioSessao) {
                var params = {
                    'aProp': aProp,
                    'aStatus': aStatus,
                    'aPrograma': aPrograma,
                ...
                return $$callGetJson('/WVDF_WS/ws_hcgs3004.wso/p_att_status/JSON', params);
            },
        ...
        WS_csag320: {
            f_bCSAG342_armador: function(sInicial, sSessionId) {
                var params = {
                    'sInicial': sInicial,
                    'sSessionId': sSessionId
                }
        ...
        ws_HCGS3001: {
            ...
            taxas_tarifarioxproposta: function(aClasse, aProp, aUsuarioSessao) {
                var params = {
                    'aClasse': aClasse,
                    'aProp': aProp,
                    'aUsuarioSessao': aUsuarioSessao
