...
/// <summary>
/// Entidade que representa um tarifário no sistema
/// </summary>
public class Tariff
{
    /// <summary>
    /// Identificador único do tarifário
    /// </summary>
    ...
    /// <summary>
    /// Código da cidade de via (opcional)
    /// </summary>
    ...
    /// <summary>
    /// Navegação para cidade de via
    /// </summary>
    public City? ViaCity { get; set; }
    ...
    /// <summary>
    /// Verifica se o tarifário possui ponto via
    /// </summary>
    public bool HasViaPoint => !string.IsNullOrEmpty(Via);
