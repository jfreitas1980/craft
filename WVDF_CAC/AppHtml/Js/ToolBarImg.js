...
function jsSalvar(formulario) {
	...
	jConfirm('Deseja Salvar este Registro?','Atencao',function(r) {if (r) {jsCurrentForm.action = (jsAction+'&Save=1');jsCurrentForm.submit();}});
}
...
function jsSalvarFechar(formulario) {
	...
	jsCurrentForm = jsForms[formulario];
	jsAction      = jsCurrentForm.getAttribute('action');
	jConfirm('Deseja Salvar este Registro?','Atencao',function(r) {if (r) {jsCurrentForm.action = (jsAction+'&Save=1');jsCurrentForm.submit(); top.close();}});
}
...
function jsExcluir(formulario) {
	...
	jsCurrentForm = jsForms[formulario];
	jsAction   = jsCurrentForm.getAttribute('action');
	jConfirm('Deseja Excluir este Registro?','Atencao',function(r) {if (r) {jsCurrentForm.action = (jsAction+'&Delete=1');jsCurrentForm.submit();}});
}
...
function jsRefresh(formulario) {
	...
	jsCurrentForm = jsForms[formulario];
	jsAction   = jsCurrentForm.getAttribute('action');
	jConfirm('Deseja Limpar este Registro?','Atencao',function(r) {if (r) {jsCurrentForm.action = (jsAction+'&Clear=1');jsCurrentForm.submit();}});
}
